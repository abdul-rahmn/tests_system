                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            Future.delayed(Duration(seconds: 1), () {
                              Provider.of<SMProvider>(context, listen: false)
                                  .getStudentQuestions(this.courseId);
                              Navigator.of(context).pop();
                            });
                            Future.delayed(Duration(seconds: 1), () {
                              Provider.of<SMProvider>(context, listen: false)
